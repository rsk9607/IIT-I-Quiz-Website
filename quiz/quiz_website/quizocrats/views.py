...
def create(request):
  if request.method=='POST':
    ...
    op1_2=request.POST.get('Op1.1')
    op1_3=request.POST.get('Op1.1')
    op1_4=request.POST.get('Op1.1')
    ques2=request.POST.get('Q1')
    ans2=request.POST.get('A1')
    op2_1=request.POST.get('Op1.1')
    op2_2=request.POST.get('Op1.1')
    op2_3=request.POST.get('Op1.1')
    op2_4=request.POST.get('Op1.1')
    ques3=request.POST.get('Q1')
    ans3=request.POST.get('A1')
    op3_2=request.POST.get('Op1.1')
    op3_1=request.POST.get('Op1.1')
    op3_3=request.POST.get('Op1.1')
    op3_4=request.POST.get('Op1.1')
    ques4=request.POST.get('Q1')
    ans4=request.POST.get('A1')
    op4_1=request.POST.get('Op1.1')
    op4_2=request.POST.get('Op1.1')
    op4_3=request.POST.get('Op1.1')
    op4_4=request.POST.get('Op1.1')
    ques5=request.POST.get('Q1')
    ans5=request.POST.get('A1')
    op5_1=request.POST.get('Op1.1')
    op5_2=request.POST.get('Op1.1')
    op5_3=request.POST.get('Op1.1')
    op5_4=request.POST.get('Op1.1')
